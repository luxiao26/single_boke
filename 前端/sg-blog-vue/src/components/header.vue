...
<div class="">
			...
			<el-col :span="24">
				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-menu-item index="/Reward"><i class="fas fa-dollar-sign"></i> 赞赏</el-menu-item>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg05.jpg)'}">
		...
		<div class="h-information" v-if="userAvater!=null">
...
export default {
	...
	methods: { //事件处理器
		...
		loadAvater() {
			...
			if (parsedUserInfo && parsedUserInfo.avatar) {
				this.userAvater = parsedUserInfo.avatar;
			}
		},
