...
public enum AppHttpCodeEnum {
    ...
    NO_OPERATOR_AUTH(403,"您没有相关权限"),
    SYSTEM_ERROR(500,"出现错误"),
    SYSTEM_LOGIN_ERROR(399,"你已被封禁，请联系管理员解封"),
    SYSTEM_EXITS_NO(360,"你的账号已被管理员删除"),
    USERNAME_EXIST(501,"用户名已存在"),
    PHONENUMBER_EXIST(502,"手机号已存在"),
    EMAIL_EXIST(513, "邮箱已存在"),
    NAME_EXIST(514,"昵称已存在，修改失败请刷新页面查看最新数据"),
