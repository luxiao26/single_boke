        ...
        <div class="detailBox tcommonBox" >
            ...
            <header>
                ...
                <div class="tag-container">
                    <el-tag v-for="(tag, tagIndex) in detailObj.tagNameList" :key="'tag'+tagIndex" :type="getTagType(tagIndex)" style="position: relative;top: -22px;margin-left: 8px;cursor: pointer;">
                        {{ tag }}
                    </el-tag>
                </div>
            </header>
