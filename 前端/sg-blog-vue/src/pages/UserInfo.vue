...
<img v-if="userInfoObj.avatar!=null" :src="userInfoObj.avatar" class="avatar">
                                <img v-if="userInfoObj.avatar==null" src="static/img/tou.jpg" class="avatar">
                        ...
                        <li class="username">
                            ...
                            <el-input v-model="userInfoObj.password" placeholder="留空表示不修改密码"></el-input>
                        </li>
                        <li class="phonenumber">
                            <span class="leftTitle">手机号码</span>
                            <el-input v-model="userInfoObj.phonenumber" placeholder="手机号码"></el-input>
                        </li>
                        <li>
            ...
            <div v-show="!isEdit" class="tcommonBox">
                <header>
                    <h1>
                            个人中心
                        <span class="gotoEdit" @click="infoTip"><i class="fa fa-wa fa-edit"></i>编辑</span>
                    </h1>
                ...
                <section>
                    <ul class="userInfoBox">
                        ...
                        <li>
                            <span class="leftTitle">性别</span>
                            <span v-if="userInfoObj.sex!=null">{{userInfoObj.sex==1?'女':'男'}}</span>
                            <span v-if="userInfoObj.sex==null">无</span>
                        </li>
                    </ul>
    ...
    export default {
        ...
        methods: { //事件处理器
            ...
            infoTip() {
                ...
                this.$notify({
                    title: '温馨提示',
                    message: '昵称就是你登录时的用户名，请牢记修改后的昵称和密码'
                });
            },
            ...
            saveInfoFun: function(){//保存编辑的用户信息
                ...
                if(!that.userInfoObj.nickName){
                     that.$message.error('请填写昵称');
                     return;
                }
                if(!that.userInfoObj.email){
                     that.$message.error('请填写电子邮件');
                     return;
                }
                if(!that.userInfoObj.phonenumber){
                     that.$message.error('请填写手机号码');
                     return;
                }
                if(!that.userInfoObj.sex){
                ...
                userInfoObj.avatar = this.userInfoObj.avatar;
